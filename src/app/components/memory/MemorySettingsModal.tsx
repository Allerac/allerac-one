    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className={`backdrop-blur-md rounded-lg shadow-xl max-w-2xl w-full max-h-[80dvh] flex flex-col ${isDarkMode ? 'bg-gray-800/95 border border-gray-700' : 'bg-white/95 border border-gray-200'}`}>
        <div className={`p-6 border-b ${isDarkMode ? 'border-gray-700' : 'border-gray-200'}`}>
          <h2 className={`text-xl font-semibold ${isDarkMode ? 'text-gray-100' : 'text-gray-900'}`}>Consciousness</h2>
        ...
        <div className="p-6 flex-1 overflow-y-auto">
          <div>
            <textarea
              ...
              placeholder="Who you are, how you like to work, what the AI should always know about you..."
              rows={12}
            ...
            <p className={`text-xs mt-2 ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
              Only you can see this. It is never shared or visible to anyone else.
            </p>
          </div>
        </div>
