...
| [Provider-Independent Local Embeddings](provider-independent-local-embeddings.md) | Proposed — high priority | Replace the retired GitHub Models integration with benchmarked local embeddings behind a provider-neutral contract |
